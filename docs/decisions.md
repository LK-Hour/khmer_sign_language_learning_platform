...
19. **Area:** Contributor workflow (Finger Spelling)  
   **Decision:** Add dedicated contributor docs in `docs/finger-spelling-ownership-checklist.md` and `docs/finger-spelling-contributor-guide.md` as the canonical task split and implementation map for Finger Spelling work.  
   **Reason:** Improves teammate coordination, clarifies ownership boundaries, and speeds up Phase 2 delivery without changing architecture rules.
